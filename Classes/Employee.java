...
public class Employee {
		...
		public Employee(String firstName, String lastName, String SSNumber, String address, String dateOfBirth,
				...
				int IDNumber, int benefitsPackageNumber, int hoursWorkedLastPayPeriod, boolean fullTime) {
		...
		public void setBenefitsPackageNumber(int benefitsPackageNumber) {
			this.benefitsPackageNumber = benefitsPackageNumber;
		}
		...
		public int getBenefitsPackageNumber() {
			return benefitsPackageNumber;
		}
		...
		public void print() {
			...
			System.out.println(benefitsPackageNumber);
